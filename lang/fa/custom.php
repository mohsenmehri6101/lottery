...
return [
    ...
    'geographical' => [
        ...
        'cities' => [
            'id' => 'شناسه جدول شهرها',
            'name' => 'نام شهر',
            'province_id' => 'شناسه استان مربوطه',
            'status' => 'وضعیت',
        ],
    ],
    'configs' => [
    ...
    'gyms' => [
        ...
        'complaints' => [
            ...
            'user_creator' => 'شناسه کاربر ایجاد کننده',
            'user_editor' => 'شناسه کاربر ویرایش کننده',
            'factor_id' => 'شناسه فاکتور',
            'gym_id' => 'شناسه باشگاه',
            'reserve_id' => 'شناسه رزرو',
            'reserve_template_id' => 'شناسه نمونه رزرو',
            'common_complaint_id' => 'شناسه شکایت عمومی',
        ],
        'common_complaints' => [
            'text' => 'متن',
        ],
