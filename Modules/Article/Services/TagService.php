...
use Modules\Article\Http\Requests\Tag\TagIndexRequest;
use Modules\Article\Http\Requests\Tag\TagShowRequest;
use Modules\Article\Http\Requests\Tag\TagStoreRequest;
use Modules\Article\Http\Requests\Tag\TagUpdateRequest;
use Modules\Article\Entities\Tag;
use Modules\Article\Entities\Article;
use Modules\Article\Http\Repositories\TagRepository;
use Modules\Article\Http\Requests\Tag\DeleteTagToArticleRequest;
use Modules\Article\Http\Requests\Tag\SyncTagToArticleRequest;
...
class TagService
{
    ...
    public function syncTagToArticle(SyncTagToArticleRequest|array $request): bool
    {
        DB::beginTransaction();
        try {
            if (is_array($request)) {
                $loginRequest = new SyncTagToArticleRequest();
                $fields = Validator::make(data: $request,
    ...
    public function deleteTagToArticle(DeleteTagToArticleRequest $request)
    {
        DB::beginTransaction();
        try {
            $fields = $request->validated();
            ...
            # detach tag to article
            $article->tags()->detach($tags, $touch);
