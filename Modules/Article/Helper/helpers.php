...
if (!function_exists('deleteReservedWithStatusReserving')) {
    ...
    {
        /** @var Modules\Article\Entities\Reserve $reserves_with_status_status_reserving */
        $reserves_with_status_status_reserving = Modules\Article\Entities\Reserve::query()
            ->where('status',Modules\Article\Entities\Reserve::status_reserving)
