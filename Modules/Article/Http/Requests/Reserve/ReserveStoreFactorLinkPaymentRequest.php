...
class ReserveStoreFactorLinkPaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reserves.*.article_id' => 'required|exists:articles,id',
            ...
            // todo should be allow user can send user_id? infact from article-manager if want set reserve from customers-special.
