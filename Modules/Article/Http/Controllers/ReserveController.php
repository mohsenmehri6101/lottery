...
use Modules\Article\Services\ReserveService;
...
class ReserveController extends Controller
{
     ...
     *     @OA\Parameter(name="withs",in="query",required=false, @OA\Schema(type="string"),description="relations:list is:userCreator,userEditor,user,reserveTemplate,article,factors"),
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/reserves/my-article-reserves",
     *     tags={"reserves"},
     ...
     *  )
     */
    public function myArticleReserve(MyArticleReserveRequest $request): JsonResponse
    {
        $reserves = $this->reserveService->myArticleReserve($request);
        return ResponseHelper::responseSuccess(data: $reserves);
    }
     ...
     *                     @OA\Property(property="article_id", type="integer", description="ID of the articles", example=1),
