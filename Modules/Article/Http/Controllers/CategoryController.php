...
class CategoryController extends Controller
{
    ...
    /**
     * @OA\Post (
     *     path="/api/v1/categories/sync-category-to-article",
     *     tags={"categories"},
     ...
     *  )
     */
    public function syncCategoryToArticle(SyncCategoryToArticleRequest $request): JsonResponse
    {
        $status = $this->categoryService->syncCategoryToArticle($request);
        return $status ? ResponseHelper::responseSuccess() : ResponseHelper::responseFailed();
    }

    /**
     * @OA\Post (
     *     path="/api/v1/categories/delete-category-to-article",
     *     tags={"categories"},
     ...
     *  )
     */
    public function deleteCategoryToArticle(DeleteCategoryToArticleRequest $request): JsonResponse
    {
        $status = $this->categoryService->deleteCategoryToArticle($request);
        return $status ? ResponseHelper::responseSuccess() : ResponseHelper::responseFailed();
    }
}
