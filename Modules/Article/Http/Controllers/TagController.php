...
class TagController extends Controller
{
    ...
    /**
     * @OA\Post (
     *     path="/api/v1/tags/sync-tag-to-article",
     *     tags={"tags"},
     ...
     *  )
     */
    public function syncTagToArticle(SyncTagToArticleRequest $request)
    {
        $status = $this->tagService->syncTagToArticle($request);
        return $status ? ResponseHelper::responseSuccess() : ResponseHelper::responseFailed();
    }

    /**
     * @OA\Post (
     *     path="/api/v1/tags/delete-tag-to-article",
     *     tags={"tags"},
    ...
    {
        $status = $this->tagService->deleteTagToArticle($request);
        return $status ? ResponseHelper::responseSuccess() : ResponseHelper::responseFailed();
    }
