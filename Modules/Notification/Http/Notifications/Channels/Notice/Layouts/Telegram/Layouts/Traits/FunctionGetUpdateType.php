...
namespace Modules\Notification\Http\Notifications\Channels\Notice\Layouts\Telegram\Layouts\Traits;
...
trait FunctionGetUpdateType
{
    ...
    public function sendContact($phoneNumber,$chat_id,$firstName,$lastName=null){
        $content = [
            'chat_id' => $chat_id,
    ...
    public function sendSticker($sticker,$chat_id){
        $content = [
            'chat_id' => $chat_id,
    ...
    public function sendVideo($video,$chat_id,$caption=null){
        $content = [
            'chat_id' => $chat_id,
    ...
    public function sendPhoto($image,$chat_id,$caption=null){
        //9C01604423434.jpg
        $content=[
            'chat_id'=>$chat_id,
    ...
    public function sendAudio($audio,$chat_id,$caption=null,$title=null,$performer=null){
        //9C01604423434.jpg
        $content = [
            'chat_id' => $chat_id,
